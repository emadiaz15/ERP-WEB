...
from apps.users.api.views.user import (
    ...
    image_delete_view, image_replace_view, user_lookup_view
)
...
urlpatterns = [
    ...
    path('lookup/', user_lookup_view, name='user_lookup'),
    ...
    # Permitir borrar usando query param file_path (evita problemas con slashes codificados)
    path('image/delete/', image_delete_view, name='image_delete_by_query'),
