...
const ViewSubproductModal = ({ subproduct, isOpen, onClose, mediaPanel, loading = false }) => {
        ...
        >
            <div className="flex flex-col lg:flex-row gap-4 h-full text-text-primary">
                ...
                <div className="flex-1 space-y-2 bg-background-100 p-4 rounded overflow-y-auto max-h-[80vh]">
                    ...
                    <p><strong>Cantidad Ingresada:</strong> {subproduct.initial_stock_quantity ?? "N/A"} mts</p>
                    ...
                    <p><strong>Fecha de Ingreso:</strong> {formatArgentineDate(subproduct.created_at)}</p>
                    <p><strong>Modificado en:</strong> {formatArgentineDate(subproduct.modified_at)}</p>
