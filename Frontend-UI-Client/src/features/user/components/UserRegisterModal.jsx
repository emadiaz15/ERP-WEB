  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Registrar Nuevo Usuario" position="center">
      <form onSubmit={handleSubmit} encType="multipart/form-data" noValidate>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
          <FormInput label="Contraseña" name="password" type="password" autoComplete="new-password" value={formData.password} onChange={handleChange} required error={validationErrors.password} />
          <FormInput label="Confirmar Contraseña" name="confirmPassword" type="password" autoComplete="new-password" value={formData.confirmPassword} onChange={handleChange} required error={validationErrors.confirmPassword} />
        </div>
